...
def Showimg():
	...
	os.startfile("C:\Harshith\yolov5\runs\detect\exp")
...
def SourceBrowse():
	...
	# to list using list()
	root.files_list = list(filedialog.askopenfilenames(initialdir ="sign\test\images"))
...
def CopyFile():
	...
	os.system("python C:\Harshith\yolov5\detect.py --source 0 --weights C:\Harshith\yolov5\runs\train\exp4\weights\best.pt --data C:\Harshith\yolov5\sign\data.yaml")
